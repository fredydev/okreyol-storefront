...
export default function Annoucement({announcement}) {
    ...
    return (
      <div  className={"h-auto lg:h-10 cursor-pointer px-10 py-2 text-center lg:flex w-full items-center justify-center bg-corange text-white"} onMouseEnter={() => setHovered(true)}
